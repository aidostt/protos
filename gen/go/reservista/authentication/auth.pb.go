...
var file_reservista_authentication_auth_proto_depIdxs = []int32{
	4, // 0: auth.Auth.SignUp:input_type -> auth.SignUpRequest
	7, // 1: auth.Auth.SignIn:input_type -> auth.SignInRequest
	5, // 2: auth.Auth.Refresh:input_type -> auth.TokenRequest
	1, // 3: auth.Auth.IsAdmin:input_type -> auth.IsAdminRequest
	0, // 4: auth.Auth.CreateSession:input_type -> auth.CreateRequest
	2, // 5: auth.Auth.SignUp:output_type -> auth.ActivationToken
	6, // 6: auth.Auth.SignIn:output_type -> auth.TokenResponse
	6, // 7: auth.Auth.Refresh:output_type -> auth.TokenResponse
	3, // 8: auth.Auth.IsAdmin:output_type -> auth.IsAdminResponse
	6, // 9: auth.Auth.CreateSession:output_type -> auth.TokenResponse
